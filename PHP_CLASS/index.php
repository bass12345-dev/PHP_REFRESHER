...
<script>
    ...
    const load_data = () => {
        ...
        xhr.open('GET', '/PHP_APPLYING/PHP_CLASS/api/table_api.php');
        xhr.send();
    ...
    document.getElementById('user_form').addEventListener('submit', function (e) {
        ...
        xhr.open('POST', '/PHP_APPLYING/PHP_CLASS/api/submit_data.php', true);
    ...
    document.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('delete')) {
            ...
            xhr = new XMLHttpRequest();
            xhr.open('POST', '/PHP_APPLYING/PHP_CLASS/api/delete_data.php');
